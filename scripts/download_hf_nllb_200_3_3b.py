#!/usr/bin/env python3
"""
Download facebook/nllb-200-3.3B from Hugging Face into this repository's
models/ directory.
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Download facebook/nllb-200-3.3B to models/")
    parser.add_argument(
        "--repo-id",
    ...
    parser.add_argument(
        "--local-dir",
        type=Path,
        default=root() / "models" / "facebook_nllb-200-3.3B",
